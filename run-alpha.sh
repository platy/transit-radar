...
export PORT=8002 STATIC_DIR=/app/transit-radar/frontend-alpha GTFS_DIR=/app/transit-radar/gtfs LINE_COLORS=/app/transit-radar/Linienfarben.csv RUST_BACKTRACE=1
