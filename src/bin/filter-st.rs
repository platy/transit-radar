...
use transit_radar::gtfs::{Route, RouteType, StopTime, Trip};
...
fn mainr() -> Result<(), Box<dyn Error>> {
    ...
    for result in rdr.deserialize() {
        ...
        if [RouteType::UrbanRailway, RouteType::SuburbanRailway].contains(&route.route_type) {
            // ubahn / sbahn
